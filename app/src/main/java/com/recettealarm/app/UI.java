...
public class UI{
 ...
 static TextView iconBtn(Context c,String t){TextView v=center(c,t,26,Typeface.BOLD);v.setTextColor(dark);v.setBackground(stroke(c,Color.WHITE,dp(c,18),Color.rgb(236,222,207)));v.setGravity(Gravity.CENTER);LinearLayout.LayoutParams lp=new LinearLayout.LayoutParams(dp(c,52),dp(c,52));lp.setMargins(0,0,dp(c,8),dp(c,8));v.setLayoutParams(lp);return v;}
